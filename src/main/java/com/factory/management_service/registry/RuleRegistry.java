...
public class RuleRegistry {
    ...
    public void init() {
        ...
        rules.put(
                new RuleKey("Soft Bake Temp", "Rule 1"),
        ...
        rules.put(
                new RuleKey("Soft Bake Temp", "Rule 2"),
        ...
        rules.put(
                new RuleKey("Soft Bake Temp", "Rule 3"),
        ...
        rules.put(
                new RuleKey("Exposure Dose", "Rule 1"),
        ...
        rules.put(
                new RuleKey("Exposure Dose", "Rule 2"),
        ...
        rules.put(
                new RuleKey("Exposure Dose", "Rule 3"),
